...
<form name="frmRegistration" method="post" action="addadmin.php"> 
...
<label for="contact" class="lbl2"> Contact</label>
<input type="number"  name="contact" class="cont" required><br>
<label for="Gender:"class="lbl" >Gender:</label><select name="gander" class="ged" style="color: black; width:30%; padding: 8px; border: 2px solid steelblue; border-radius: 4pxcontact;">>
	<option>Male</option>
